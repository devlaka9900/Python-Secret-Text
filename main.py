...
def decrypt():
    ...
    if password == "1234":
        ...
        decrypt = base64_message=base64_bytes.decode("ascii")

        Label(screen2,text="DECRYPTION", font="arial", fg="white", bg="#00bd56").place(x=10, y=0)
...
def encrypt():
    ...
    if password == "1234":
        ...
        encrypt = base64_message=base64_bytes.decode("ascii")
